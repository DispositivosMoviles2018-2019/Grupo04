...
import ec.edu.uce.ex2h_g04.controlador.ReservaControl;
import ec.edu.uce.ex2h_g04.modelo.Globales;
import ec.edu.uce.ex2h_g04.modelo.InterfazCRUD;
import ec.edu.uce.ex2h_g04.modelo.MailJob;
...
public class ReservarActivity extends AppCompatActivity implements InterfazCRUD {
    ...
    private final long VALOR_DIA = (long) 60.0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fechaP.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start,
                ...
                try {
                    double val = restarFechas(simpleDate.parse(fechaE.getText().toString()), simpleDate.parse(fechaP.getText().toString())) ;
                    if (val<7){
                        val = val * VALOR_DIA;
                    }else {
                        val = (val * VALOR_DIA)+6;
    ...
    public int restarFechas(Date hoy, Date fecha) {
       ...
       /* long diferencia = 0;
        ...
        if (valI >= 7) {
            System.out.println("Mayor q 7 dias");
            diferencia = 1;
        }else {
            System.out.println("Menor q 7 dias");
            diferencia = 0;
        }*/
