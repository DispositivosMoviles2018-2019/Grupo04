...
import ec.edu.uce.ex2h_g04.controlador.UsuarioControl;
import ec.edu.uce.ex2h_g04.modelo.Globales;
...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtRegis = (TextView) findViewById(R.id.txtRegistrarUser);
        txtRegis.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                irRegistro();
            }
    ...
    private void attemptLogin() {
        ...
        if (!TextUtils.isEmpty(password) && !isPasswordValid(password)) {
            mPasswordView.setError("La clave es muy corta la longitud minima es 6 caracteres con 3 letras Mayusculas");
    ...
    private boolean isPasswordValid(String password) {
        Pattern restriccion = Pattern.compile("(?:.*[a-zA-Z0-9]){3}");
