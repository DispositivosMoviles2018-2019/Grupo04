package com.example.luisalejandro.lcardenas_ex_1h.vista;
...
import com.example.luisalejandro.lcardenas_ex_1h.R;
import com.example.luisalejandro.lcardenas_ex_1h.controlador.VehiculoControlador;
import com.example.luisalejandro.lcardenas_ex_1h.modelo.Vehiculo;
...
public class ListarActivity extends AppCompatActivity {
    ...
    public void crear(View view) {
        ...
        final RadioGroup rg = (RadioGroup) d.findViewById(R.id.rg_colores);
    ...
    public void editarVehiculo(final AdapterView.AdapterContextMenuInfo aInfo,Object vehiculos) {
        ...
        String[] color = {"plomo","celeste","Rojo","verde"};
        spinner.setAdapter(new ArrayAdapter<String>(this, android.R.layout.simple_spinner_item, color));
